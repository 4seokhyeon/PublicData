package com.example.publicdatamise
...
import com.example.publicdatamise.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpDustParameter(sido: String): HashMap<String, String> {
        val authKey =
            "\t\n" +
                    "+Yd0CmuD0wPButJSjoATbVHNFyvbXSwuQ1evW4HUK8kEe7DyfzW7lVhZa5Ct3+D5t9095OR/dRRHNhKJcG0zbg=="
